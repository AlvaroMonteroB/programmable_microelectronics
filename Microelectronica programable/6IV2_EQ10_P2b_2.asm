;INSTITUTO POLITECNICO NACIONAL.
 ...
 ;
 ;
 ;Este programa ejecuta un pwm que sube y baja el voltaje con 2 botones
;---------------------------------------------------------------------------------------------
 list p=16f877A
...
GLMotor    equ     .6; // Bit que controla el comun del display 6.
GHMotor     equ     .7; // Bit que controla el comun del display 7.


progc         equ b'11000000'; // Programaciòn inicial del puerto C.
...
Bot_abajomot1           btfss portc,glmotor;
                        goto en_bajomot1;
                        goto loop_prin;
en_bajomot1             movlw .0;
                        xorwf ccpr1l,w;
